...
echo "elements,insertion_copy,insertion_move,emplace,clear,find_unbalanced,suscription_retrieve,subscription_setting,copy_assignment,copy_construction,move_assignment,move_construction" > reports/report_bst.csv
...
do
  ...
  RESULT=$(awk "NR==17, NR==27 {print \$5} END {}" ORS="" reports/report_${i}.txt)
